		...
		<>
			<div className="flex gap-6 items-center">
				...
				<div className="flex flex-col gap-2">
					...
					<div className="p-1 text-xs bg-zinc-700 w-fit rounded-md flex items-center justify-center">
						<p>Get Support</p>
					</div>
				</div>
			</div>
						...
						<div className="flex gap-6 ">
							<div className="relative p-0.5">
								...
								<div
									...
									className="relative h-20 w-20 rounded-full bg-white border-white border-solid border-2"
								></div>
							</div>
							<div className="flex flex-col">
